...
async function createUser(username) {
  ...
  try {
    const response = await cognitoIdentityProviderClient.send(new AdminCreateUserCommand(params));
...
async function deleteUser(username) {
  ...
  try {
    await cognitoIdentityProviderClient.send(new AdminDeleteUserCommand(params));
