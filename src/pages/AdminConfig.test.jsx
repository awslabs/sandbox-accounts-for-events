...
test("renders AdminConfig, enters valid and invalid texts, submits", async () => {
    ...
    const fetchConfigAction = vi.spyOn(actions, "fetchConfig").mockImplementation((fetchConfig) => () => fetchConfig)
    ...
    const saveConfigAction = vi.spyOn(actions, "updateConfig").mockImplementation((updateConfig) => () => updateConfig)
